...
local function register_pane(name, desc, def)
	xpanes.register_pane(name, {
		...
		drawtype = "airlike",
		paramtype = "light",
		textures = {"xdecor_" .. name .. ".png", "xdecor_" .. name .. ".png", "xpanes_edge.png"},
...
minetest.register_alias("baricade", "trap:baricade")
minetest.register_alias("xdecor:baricade", "trap:baricade")
--[[
...
xdecor.register("chair", {
	...
	on_rightclick = function(pos, node, clicker, itemstack, pointed_thing)
		...
		minetest.after(0.34, cozy.set, clicker:get_player_name(), "sit", pos)
		return itemstack
	end
})

minetest.register_alias("cobweb", "trap:cobweb")
minetest.register_alias("xdecor:cobweb", "trap:cobweb")
--[[
...
register_hard_node("packed_ice", "Packed Ice", {
	groups = {cracky = 1, melty = 1, slippery = 3},
	sounds = default.node_sound_glass_defaults()
})
...
xdecor.register("trampoline", {
	...
	groups = {cracky = 3, oddly_breakable_by_hand = 1, fall_damage_add_percent = -100, bouncy = 101},
	node_box = xdecor.nodebox.slab_y(0.5),
	sounds = {
		footstep = {
			name = "xdecor_bouncy",
