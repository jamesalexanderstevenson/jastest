...
protector.can_dig = function(r, pos, digger, onlyowner, infolevel)
	...
	if infolevel == 2 then
		if #pos < 1 then
			hud.message(digger, S("This area is not protected."))
		end
		hud.message(digger, S("You can build here."))
	end
	return true
end
...
minetest.register_node("protector:protect", {
	...
	tiles = {
		...
		"xdecor_stone_rune.png",
		"xdecor_stone_rune.png^protector_logo.png"
	},
...
minetest.register_craft({
	...
	type = "shapeless",
	recipe = {"default:tin_ingot", "default:gold_ingot", "default:steel_ingot"}
})
