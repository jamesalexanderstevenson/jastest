minetest.register_node("clothing:loom", {
	...
	on_construct = function(pos)
		...
		meta:set_string("formspec",
			...
			forms.x ..
			forms.q ..
			forms.title("Clothing Loom") ..
			"label[0,3;Input Wool]" ..
			"list[current_name;input;0.5,2;1,1;]" ..
			"label[6,3;Output Wool]" ..
			...
			"listring[current_player;main]" ..
			forms.get_hotbar_bg(0, 4.667) ..
		"")
		meta:set_string("infotext", "Clothing Loom")
		local inv = meta:get_inventory()
