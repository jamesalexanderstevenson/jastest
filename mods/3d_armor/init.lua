...
local skin_mods = {"skins", "u_skins", "simple_skins"}
...
armor:register_on_damage(function(player, index, stack)
	...
	if name and def and def.description and stack:get_wear() > 60100 then
		hud.message(player, S("Your @1 is almost broken!", def.description))
		minetest.sound_play("default_tool_breaks", {to_player = name, gain = 0.25}, true)
	end
	hud.update(player)
end)
armor:register_on_destroy(function(player, index, stack)
	...
	if name and def and def.description then
		hud.message(player, S("Your @1 got destroyed!", def.description))
		minetest.sound_play("default_tool_breaks", {to_player = name, gain = 0.2}, true)
	end
	hud.update(player)
end)
...
minetest.register_on_newplayer(function(player)
	minetest.after(0.36, function()
		...
		inv:add_item("armor", "3d_armor:helmet_wood")
		inv:add_item("armor", "3d_armor:chestplate_wood")
		inv:add_item("armor", "3d_armor:leggings_wood")
		inv:add_item("armor", "3d_armor:boots_wood")
		inv:add_item("armor", "3d_armor:shield_enhanced_wood")
...
if armor.config.punch_damage == true then
	minetest.register_on_punchplayer(function(player, hitter,
		...
		if name then
			...
			--print("punchplayer punching armor")
		end
	end)
end
