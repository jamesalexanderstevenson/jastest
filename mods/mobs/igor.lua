...
mobs:register_mob("mobs:igor", {
	...
	on_rightclick = function(self, clicker)
		...
		if item:get_name() == "default:gold_lump" then
			...
			hud.message(clicker, S("NPC dropped you an item for gold!"))
		...
		if self.owner and self.owner == name then
			...
			if self.order == "follow" then
				...
				hud.message(clicker, S("NPC stands still."))
			else
				self.order = "follow"
				--minetest.chat_send_player(name, S("NPC will follow you."))
				hud.message(clicker, S("NPC will follow you."))
			end
		end
	end,
})
-- register spawn egg
mobs:register_egg("mobs:igor", S("Igor"), "mobs_meat_raw.png", 1)
