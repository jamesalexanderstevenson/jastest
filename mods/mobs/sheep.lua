...
for _, col in ipairs(all_colours) do
	...
	mobs:register_mob("mobs:sheep_"..col[1], {
		...
		pushable = true,
		drops = {
			{name = "bones:bone", chance = 1, min = 1, max = 2},
			{name = "mobs:mutton_raw", chance = 3, min = 1, max = 1},
			{name = "wool:" .. col[1], chance = 5, min = 0, max = 1},
		},
		--water_damage = 3,
		--lava_damage = 5,
		suffocation = 4,
...
mobs:register_egg("mobs:sheep_"..col[1], S("@1 Sheep", col[2]), "wool_"..col[1]..".png^mobs_sheep_inv.png")

	-- compatibility
	mobs:alias_mob("mobs:sheep_" .. col[1], "mobs:sheep_" .. col[1])

end

--[[
mobs:spawn({
	name = "mobs:sheep_white",
