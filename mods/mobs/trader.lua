...
mobs.human = {
	...
	items = {
		...
		{"caverealms:glow_amethyst 1", "mtd:gold_coin 5", 90},
		{"caverealms:glow_emerald 1", "mtd:gold_coin 2", 17},
		{"caverealms:glow_mese 1", "mtd:gold_coin 2", 7},
		{"caverealms:glow_ruby 1", "mtd:gold_coin 1", 17},
		...
		{"default:permafrost 10", "mtd:gold_coin 8", 17},
		{"default:permafrost_with_moss 1", "mtd:gold_coin 1", 7},
		{"default:permafrost_with_stones 1", "mtd:gold_coin 1", 7},
		{"default:sand 20", "mtd:gold_coin 4", 17},
		{"default:sapling 5", "mtd:gold_coin 15", 50},
		{"default:tree 5", "mtd:gold_coin 4", 20},
		{"farming:bread 10", "mtd:gold_coin 4", 5},
		{"farming:seed_wheat 4", "mtd:gold_coin 5", 40},
		{"farming:wheat 10", "mtd:gold_coin 20", 17},
	}
}

-- Trader ( same as NPC but with right-click shop )

mobs:register_mob("mobs:trader", {
	description = "Trader",
	type = "npc",
	passive = false,
	damage = 3,
...
function mobs_trader(self, clicker, race)
	...
	minetest.show_formspec(player, "mobs:trade", "size[8,10]"
		.. default.gui_bg_img
		.. default.gui_slots
...
minetest.register_on_player_receive_fields(function(player, formname, fields)
	...
	if formname ~= "mobs:trade" then return end
...
mobs:register_egg("mobs:trader", S("Trader"), "default_sandstone.png", 1)
