...
minetest.register_node("foodblock:pudding", {
	...
	paramtype = "light",
	tiles = {
		"foodblock_pudding_top.png",
		"foodblock_pudding_bottom.png",
		"foodblock_pudding_side.png"
	},
	groups = {crumbly = 2},
