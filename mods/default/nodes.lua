...
minetest.register_node("default:dirt_with_grass", {
	...
	drop = "default:dirt",
	sounds = default.node_sound_dirt_defaults({
		footstep = {name = "default_grass_footstep", gain = 0.75},
	}),
})
...
minetest.register_node("default:leaves_broken", {
	description = S("Apple Tree Leaves"),
	drawtype = "allfaces_optional",
	waving = 1,
	tiles = {"default_leaves.png"},
...
minetest.register_node("default:jungleleaves_broken", {
	description = S("Jungle Tree Leaves"),
	drawtype = "allfaces_optional",
	waving = 1,
	tiles = {"default_jungleleaves.png"},
...
minetest.register_node("default:pine_needles_broken",{
	description = S("Pine Needles"),
	drawtype = "allfaces_optional",
	tiles = {"default_pine_needles.png"},
	waving = 1,
...
minetest.register_node("default:acacia_leaves_broken", {
	description = S("Acacia Tree Leaves"),
	drawtype = "allfaces_optional",
	tiles = {"default_acacia_leaves.png"},
	special_tiles = {"default_acacia_leaves_simple.png"},
...
minetest.register_node("default:aspen_leaves_broken", {
	description = S("Aspen Tree Leaves"),
	drawtype = "allfaces_optional",
	tiles = {"default_aspen_leaves.png"},
	waving = 1,
...
minetest.register_node("default:bush_leaves_broken", {
	description = S("Bush Leaves"),
	drawtype = "allfaces_optional",
	waving = 1,
	tiles = {"default_leaves_simple.png"},
...
minetest.register_node("default:blueberry_bush_leaves_broken", {
	description = S("Blueberry Bush Leaves"),
	drawtype = "allfaces_optional",
	waving = 1,
	tiles = {"default_blueberry_bush_leaves.png"},
...
minetest.register_node("default:acacia_bush_leaves_broken", {
	description = S("Acacia Bush Leaves"),
	drawtype = "allfaces_optional",
	waving = 1,
	tiles = {"default_acacia_leaves_simple.png"},
...
minetest.register_node("default:pine_bush_needles_broken", {
	description = S("Pine Bush Needles"),
	drawtype = "allfaces_optional",
	waving = 1,
	tiles = {"default_pine_needles.png"},
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		if def_top and def_top.liquidtype == "source" and
			...
			if not minetest.is_protected(pos, player_name) and
				...
				hud.message(placer, "Node is protected")
	...
	minetest.register_node("default:sign_wall_" .. material, {
		...
		on_receive_fields = function(pos, formname, fields, sender)
			...
			if string.len(text) > 512 then
				...
				hud.message(sender, S("Text too long"))
				return
			end
			--minetest.log("action", (player_name or "") .. " wrote \"" ..
			print((player_name or "") .. " wrote \"" ..
...
if minetest.get_mapgen_setting("mg_name") == "v6" then
	default.register_leafdecay({
		trunks = {"default:tree"},
		leaves = {"default:apple", "default:leaves", "default:leaves_broken"},
		radius = 2,
	})
