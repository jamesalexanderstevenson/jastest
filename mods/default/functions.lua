...
function default.node_sound_stone_defaults(table)
	table = table or {}
	table.footstep = table.footstep or
			{name = "default_hard_footstep", gain = 1.0, pitch = 1.0}
	table.dug = table.dug or
			{name = "default_dug_cracky", gain = 1.0, pitch = 0.9}
	table.dig = table.dig or
			{name = "default_dig_cracky", gain = 0.9, pitch = 1.0}
...
function default.node_sound_dirt_defaults(table)
	...
	table.dug = table.dug or
			{name = "default_dirt_footstep", gain = 1.0, pitch = 1.0}
	table.place = table.place or
...
function default.register_fence(name, def)
	local joiner = "group:stick"
	if def.material_type == "metal" then
		joiner = def.material
	end
	minetest.register_craft({
		output = name .. " 4",
		recipe = {
			{ def.material, joiner, def.material },
			{ def.material, joiner, def.material },
		}
	})
